...
(function (engine) {
    ...
    var CanvasRenderer = (function () {
        ...
        CanvasRenderer.prototype.renderBitmap = function (bitmap) {
            this.context2D.drawImage(bitmap.img, bitmap.x, bitmap.y, bitmap.width, bitmap.height);
        };
        CanvasRenderer.prototype.renderTextField = function (textField) {
            this.context2D.fillStyle = textField.textColor;
            this.context2D.scale(textField.scaleX, textField.scaleY);
    ...
    (function (res_1) {
        ...
        var ImageProcessor = (function () {
            ...
            ImageProcessor.prototype.load = function (url, callback) {
                ...
                var bitmap = new engine.Bitmap(); //res.name, res.width, res.height, res.url
